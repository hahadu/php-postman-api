...
class Collections implements FunctionsContract
{
    protected $request;
    ...
    {
        $response = $this->request->get(Constants::POSTMAN_APIS_COLLECTIONS_URI.$id);
    ...
    {
        return $this->request->post(Constants::POSTMAN_APIS_COLLECTIONS_URI,$body);
    }
    ...
    {
        return $this->request->put(Constants::POSTMAN_APIS_COLLECTIONS_URI,$id,$body);
    }
    ...
    {
        return $this->request->delete(Constants::POSTMAN_APIS_COLLECTIONS_URI,$id);
    }
}
