...
class Environments implements FunctionsContract
{
    protected $request;
    ...
    {
        $result = $this->request->get(Constants::POSTMAN_APIS_ENVIRONMENTS_URI);
    ...
    {
        $response = $this->request->get(Constants::POSTMAN_APIS_ENVIRONMENTS_URI.$id);
    ...
    {
        return $this->request->post(Constants::POSTMAN_APIS_ENVIRONMENTS_URI,$body);
    }
    ...
    {
        return $this->request->put(Constants::POSTMAN_APIS_ENVIRONMENTS_URI,$id,$body);
    }
    ...
    {
        return $this->request->delete(Constants::POSTMAN_APIS_ENVIRONMENTS_URI,$id);
    }
}
